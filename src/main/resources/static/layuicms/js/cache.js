...
layui.use(['form','jquery',"layer"],function() {
    ...
    //锁屏
    function lockPage(){
        var jpgurl = $("#jpgurl").attr("src");
        var usernmae = $("#username").text();
        layer.open({
            title : false,
            type : 1,
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src= "'+jpgurl+'" class="userAvatar"/></div>'+
                            '<div class="admin-header-lock-name" id="lockUserName">'+usernmae+'</div>'+
                            '<div class="input_btn">'+
