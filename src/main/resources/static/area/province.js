...
function treeSelect(config) {
    ...
    if (uAdress != null){
        var arr = uAdress.split("-");
        $("#address").attr("value",arr[3]);
        config.v1 = config.v1 ? config.v1 : arr[0];
        config.v2 = config.v2 ? config.v2 : arr[1];
        config.v3 = config.v3 ? config.v3 : arr[2];
    }
